...
const data = [
  {
    avatar: vinh,
    name: "Tran Van Vinh",
    role: "CEO of ZoziTech and DooFinance Exchange",
    linkid: "",
    twiter: "",
  },
  {
...
export const Team = () => {
  return (
    <section id="team" className="team">
      ...
      <p className="container team__description">
        The Dooex Team combines a passion for esports, industry experise &
        proven record in finance, development, marketing & licensing.
      </p>
      <div className="container team__grid">
        {data.map((_e) => (
          <Member key={_e.avatar} {..._e} />
        ))}
      </div>
    </section>
  );
