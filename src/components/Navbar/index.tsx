        ...
        <nav className="container navbar">
            ...
            <ul className={isOpen ? "navbar__menu open" : "navbar__menu close"}>
                <div className="navbar__close" onClick={() => setIsOpen(false)} >
                    <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-chevrons-right" width="32" height="32" viewBox="0 0 24 24" strokeWidth="1" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round">
